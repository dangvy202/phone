...
class ProductController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $this->_view->categoryName = $this->_model->listCategory($this->_arrParam,null);
    ...
    //THAY ĐỔI SẢN PHẨM SPECIAL AJAX
    public function changeSpecialAction(){
        $this->_model->changeSpecial($this->_arrParam,null);

...
foreach ($this->items as $item) {
    ...
    $picture    = HelperBackend::pictureShow('item-image w-100',UPLOAD_URL.'book'.DS.$item['picture']);
    $status     = HelperBackend::showItemStatus($this->arrParam['controller'], $item['status'], $item['id']);
    $special    = HelperBackend::showItemSpecial($this->arrParam['controller'], $item['special'], $item['id']);
    ...
    <tr>
        ...
        <td class="text-center position-relative">' .   number_format($item['price']).'Đ'   .'</td>
        <td class="text-center position-relative">' .   $item['sale_off'].'%'               .'</td>
        <td class="text-center position-relative">' .   $item['cname']                      .'</td>
        ...
        <td class="text-center position-relative">' .   $created                            .'</td>
